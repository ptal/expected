  ...
  namespace functional
  {
    ...
    namespace functor
    {
      ...
      struct functor_traits<category::valued_and_errored>
      {
        ...
        static BOOST_CONSTEXPR auto fmap(F&& f, M0&& m0, M&& ...m) -> typename functional::bind2<decay_t<M0>, FR>::type
        {
          typedef typename functional::bind2<decay_t<M0>, FR>::type result_type;
    ...
    namespace monad
    {
      ...
      struct monad_traits<category::valued_and_errored>
      {
        ...
        ) -> typename functional::bind2<decay_t<M>, FR>::type
        {
